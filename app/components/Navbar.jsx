...
export default function Navbar() {
  ...
  return (
    <>
    <div className='fixed top-0 right-0 -z-10 w-11/12 tranlate-y-[-80%]'>
        <Image src={assets.header_bg_color} alt='' className='w-full' />
    </div>
        <nav className='w-full fixed p-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50'>
            <a href="#top">
                <Image src={assets.logo} alt='' className='w-55 cursor-pointer mr-14' />
            </a>
